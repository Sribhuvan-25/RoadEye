...
/// The report system prompt -- embedded copy of report/system_prompt.md
/// (the canonical file; scripts/test_swift_report.sh diffs the two and
/// fails if they drift). Edit the .md, then mirror the change here.
enum ReportPrompt {
    static let text = """
